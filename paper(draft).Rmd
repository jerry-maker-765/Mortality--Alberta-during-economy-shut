...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Comparing posterior prediction checks for Poisson and negative binomial models", fig.width=7, fig.height=3.2}
